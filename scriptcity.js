...
function buildingsDesc() {
  ...
  var description = "<p>The " + currentBuilding + " was a " + `${RiTa.randomWord('jj')} ` + currentBuilding + ", " + `${RiTa.randomWord('jj')}` + ", " + `${RiTa.randomWord('jj')}` + ", and " + `${RiTa.randomWord('jj')}` + ". " + `${rm.generateSentences(120).join(" ")}` + "</p>";
